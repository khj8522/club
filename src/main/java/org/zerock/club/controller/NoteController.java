...
public class NoteController {
    ...
    @PostMapping(value = "")
    public ResponseEntity<Long> register(@RequestBody NoteDTO noteDTO){ // JSON형태로 받은 데이터를 NoteDTO로 매핑
        log.info("------------register--------------------");
        log.info(noteDTO);
    ...
    @GetMapping(value = "/{num}", produces = MediaType.APPLICATION_JSON_VALUE) // 클라이언트에게 보낼 형식 == JSON
